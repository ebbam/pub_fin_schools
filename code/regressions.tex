...
While labour productivity has continued to rise, the earnings of typical
...
\autocite{egger2019,lee1999,mishel2021,barkai2020,autor2016,card2001,bivens2013,stansbury2020}.\footnote{Summers
  ...
  workforce (\textcite{summers2018} \textcite{stansbury}). They point to
  declining union density, erosion of the minimum wage, globalization,
  and increased market concentration as key factors that have shifted
  bargaining power away from workers and reduced labour's share of
  national income \textcite{autor2014}. Furthermore, additional evidence
...
workers, contributing to what is often termed the ``hollowing of the
middle class'' \autocite{komlos2018}. \footnote{Though authors find that
  wage inequality growth has stagnated in the last decade this is not a
  ...
  wage distribution \textcite{aeppli2022}. Additionally, further
  evidence indicates that metric choice can influence the ambiguity of
  earnings and wage inequality conclusions \textcite{parolin2025}.}
...
\autocite{bauluz,rickard2020,fee2025,storper2009,fallah2011,benmelech}.
...
\autocite{manduca2025,weir2021,schechtl2024,mettler2011}.\footnote{A
  ...
  wealth, and public service expenditure \textcite{avenancio-león2022}
  \textcite{trounstine2016} \textcite{trounstine2021} .} Existing work
shows that income inequality and uneven local income growth shape
inequalities in local public goods provision, residential mobility, and
long-run opportunity. Wage stagnation can translate directly into
weakened fiscal capacity. Put plainly, given the structure of US public
services, wherein they are tied to asset values, inequality in
...
\autocite{manduca2025,obrien2025,feler2017}.} Evidence of how income
...
located 40Km away, spent \$14,000 \autocite{semuels2016}.
...
underexplored: Are local public education budgets sensitive to local
...
is strongest or weakest, and to assess whether intergovernmental
transfers mitigate inequalities in local fiscal capacity.

\subsection{Detailed Results and
Contribution}\label{detailed-results-and-contribution}
...
\item
  ...
  weight of national-level identification. Most of these states rely on
  an above-average share of education funding coming from local sources
  (property taxes CHECK) rather than intergovernmental transfers. Across
  these states the wage elasticity varies between 2-10\% increases in
...
\autocite{ferri2022,goldsmith-pinkham2020,bartik1991}.\footnote{Autor et
  ...
  (\textcite{autor2013}). As an extension, \textcite{feler2017} use a
  similar shift-share instrument to assess the effect of the same shock
  on the size of local government. \textcite{baccini2021} employ a
...
This decomposition of local-level changes delocalises variation over
space and time. In doing so, it provides a defensible strategy for
`de-endogenising' the treatment, as local exposure is predetermined with
...
industries.\footnote{An additional popular indicator for modelling
  industrial shocks is \emph{oil price} as values are often assumed to
  be exogenous to local and even national conditions
  (\textcite{scheer2022}). Third, various indicators for measuring
  \emph{deindustrialisation} have been proposed including the
  manufacturing share of employment, value added, and GDP
  \textcite{tregenna2009}, \textcite{tregenna2020}. Finally, in rare
  instances, exogeneity can be secured due to \emph{geographical,
  climatological, or geological factors}. For example,
  \textcite{borge2015} obtain an exogenous measure of local revenue by
  ``instrumenting the variation in hydropower revenue, and thus total
  revenue, by topology, average precipitation and meters of river in
  steep terrain.'' Certain authors have argued that the fact that the
  location of hydrocarbon deposits is dictated by geomorphological
  processes provides a plausible argument for exogeneity
  \textcite{esposito2021}, \textcite{chen2022}.}
...
empirical support for a ``resource curse'' dynamic\footnote{Perhaps the
  ...
  {[}\textcite{ross2018}; @ross2015; \textcite{dialga2022}{]}. Although
  ...
  answering the research question. \autocite{ahlerup2020} find that for
  30 countries in Africa, the presence of gold mines during adolescence
  have a significant effect on educational attainment.
  \autocite{badeeb2017} investigates whether resource dependence slows
  economic growth with no explicit mention of education.
  \autocite{blanco2012} find that in Latin America, petroleum export has
  a significant long-run negative relationships with human capital.
  \autocite{borge2015} find support for the paradox of plenty hypothesis
  in Norway - that higher local public revenue negatively affects the
  efficiency of local public good provision.
  \autocite{brunnschweiler2008} critically evaluate `the empirical basis
  ...
  ``resource dependence''-endogenous to underlying structural factors.
  In multiple estimations that combine resource abundance and
  dependence, institutional, and constitutional variables, we find that
  (i) resource abundance, constitutions, and institutions determine
  resource dependence, (ii) resource dependence does not affect growth,
  and (iii) resource abundance positively affects growth and
  institutional quality.' \autocite{cockx2014} use a panel on 140
  countries from 1995-2009 and find an inverse relationship between
  resource dependence and and public health spending over time.
  ...
  curse.' \autocite{haber} focus on authoriarian regimes.
  \autocite{menaldo2016} argues again that this is an institutions curse
  and not a resource curse issure. \autocite{sincovich2018} provide a
...
used (Mb) gc trigger (Mb) limit (Mb) max used (Mb) Ncells 4599133 245.7
7280012 388.8 NA 7280012 388.8 Vcells 200573820 1530.3 258877180 1975.1
2048 203429400 1552.1
...
\begin{table}[htbp]
   \caption{\label{tbl_proptax_gdp} no title}
   \centering
   \begin{adjustbox}{width = \textwidth, center}
      \begin{tabular}{lcccc}
         \tabularnewline \midrule \midrule
