...
{{< include ../data/raw/QCEW/data_desc_qcew_cz_ind_wage_stats.md >}}
...
## Correlation Between GDP Growth Rates and Wage Growth Rates by State
...
```{r, ref.label='unnamed-chunk-22', echo = FALSE, eval=TRUE, results = 'asis'}
```
...
```{=latex}
\input{/Users/ebbamark/Documents/Documents - Nuff-Malham/GitHub/pub_fin_schools/data/raw/funding_distribution/data_desc_funding_dist.tex}
```
...
### Industry-level Shift-share Decomposition
...
```{r, ref.label='indind_SM', echo = FALSE, eval=TRUE, results = 'asis'}
```
...
## Industry-by-Industry Estimation Using Industry-Specific GDP SS
...
```{r, ref.label='indind_new_2', echo = FALSE, eval=TRUE, results = 'asis'}
```
