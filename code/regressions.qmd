...
etable(mods_wage, tex = latex_tables, adjustbox = TRUE, headers = names(mods), title = "Wage-based Shift-Share Instrument (l1) Applied to Declining Wage vs. Growing Wage Regions")
...
etable(mods_wage, tex = latex_tables, adjustbox = TRUE, title = "GDP-based Shift-Share Instrument (l1) Applied to Declining Wage vs. Growing Wage Regions", label = "tbl:wss_subsamples")
etable(mods, tex = latex_tables, adjustbox = TRUE, title = "GDP-based Shift-Share Instrument (l1) Applied to Declining GDP vs. Growing GDP Regions") 
...
```{r outliers, echo = FALSE, cache = TRUE}
...
etable(baseline, wage_ss, gdp_ss, tex = latex_tables, title = "Outlier Trimming Results")
