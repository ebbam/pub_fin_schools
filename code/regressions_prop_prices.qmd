...
iv_lev_form <- iv_lev_form <- "log_real_Elem_Educ_Total_Exp_pp ~  l1_log_real_Elem_Educ_Total_Exp_pp + log_real_Total_IG_Revenue_pp + log_real_gdp_priv_ind_pc + log_Enrollment + pct_black + pct_hispanic"
...
iv_model_2d_lev_lev <- feols(
    as.formula(paste0(iv_lev_form, " | unit + year | log_hpi ~ lev_gdp_ss_2d")),
    data = left_join(mines_cz, rename(ss_temp, unit = cz_id), by = c("year","unit")), panel.id = c("unit", "year"), cluster = "unit")
